...
public class PersonalMortgage extends Mortgage {
    ...
    public PersonalMortgage(int mortgageNo, String customerName, double amountMortgage, double interestRate, int term) {
        super( mortgageNo, customerName, amountMortgage, (interestRate+1), term);
    }
